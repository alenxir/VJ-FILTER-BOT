...
API_ID = int(environ.get('API_ID', '29867428'))
API_HASH = environ.get('API_HASH', 'ee2577c4f3a4ac8b76bbdaa013b2bb10')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002409058604'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1340821605').split()]

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002259771161').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vermashivansh092:ChSjl0tvBUD4s9ru@cluster0.khwjo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
